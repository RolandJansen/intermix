...
"use strict";var core=_dereq_("./core.js"),SoundWave=function(e){var t=this;if(this.ac=core,this.buffer=core.createBuffer(1,0,core.sampleRate),this.metaData=[],"undefined"!=typeof e)if("string"==typeof e)this.buffer=this.loadFile(e).then(function(e){return t.decodeAudioData(e)}).then(function(e){return t.buffer=e,t.buffer})["catch"](function(e){throw e});else if(e instanceof Array&&"string"==typeof e[0])this.buffer=this.loadMultipleFiles(e).then(function(e){t.buffer=e})["catch"](function(e){throw e});else if(e instanceof ArrayBuffer)this.buffer=this.decodeAudioData(e);else{if(!(e instanceof Array&&e[0]instanceof ArrayBuffer))throw new Error("Cannot create SoundWave object: Unsupported data format");this.decodeAudioSources(e).then(function(e){return t.joinAudioBuffers(e)}).then(function(e){this.buffer=e})}};SoundWave.prototype.loadMultipleFiles=function(e){var t=this,n=this.stripFilenames(e);return this.loadFiles(e).then(function(e){return t.decodeAudioSources(e)}).then(function(e){var r=[];return r.push(t.joinAudioBuffers(e),t.storeMetaData(e,n)),Promise.all(r)}).then(function(e){return t.metaData=e[1],e[0]})["catch"](function(e){throw e})},SoundWave.prototype.decodeAudioSources=function(e){var t=[];return e.forEach(function(e){t.push(this.decodeAudioData(e))},this),Promise.all(t)},SoundWave.prototype.decodeAudioData=function(e){return core.decodeAudioData(e)},SoundWave.prototype.joinAudioBuffers=function(e){var t=this,n=core.createBuffer(1,0,core.sampleRate);return new Promise(function(r,o){e.forEach(function(e){e instanceof window.AudioBuffer?n=this.appendAudioBuffer(n,e):o(new TypeError("One or more buffers are not of type AudioBuffer."))},t),r(n)})},SoundWave.prototype.appendAudioBuffer=function(e,t){if(e instanceof window.AudioBuffer&&t instanceof window.AudioBuffer){for(var n=Math.min(e.numberOfChannels,t.numberOfChannels),r=core.createBuffer(n,e.length+t.length,e.sampleRate),o=0;n>o;o++){var f=r.getChannelData(o);f.set(e.getChannelData(o),0),f.set(t.getChannelData(o),e.length)}return r}throw new TypeError("One or both buffers are not of type AudioBuffer.")},SoundWave.prototype.storeMetaData=function(e,t){var n=[],r=[],o=0,f=this;return new Promise(function(u,i){"undefined"==typeof t?e.forEach(function(e,t){n.push("fragment"+t)}):t.length===e.length?n=t:i(new Error("audioBuffers and names should be of same length")),e.forEach(function(e,n){r.push(this.getMetaData(e,t[n],o)),o+=e.length},f),u(r)})},SoundWave.prototype.stripFilenames=function(e){return e.map(function(e){return e.split("/").pop()})},SoundWave.prototype.getMetaData=function(e,t,n){if(e instanceof window.AudioBuffer&&"string"==typeof t){"undefined"==typeof n&&(n=0);var r=e.length;return{name:t,start:n,end:n+r-1,length:r}}throw new TypeError("Arguments should be of type AudioBuffer and String")},SoundWave.prototype.loadFile=function(e){return window.fetch(e).then(function(t){if(t.ok)return t.arrayBuffer();throw new Error("Server error. Couldn't load file: "+e)})},SoundWave.prototype.loadFiles=function(e){var t=[];return e.forEach(function(e){t.push(this.loadFile(e))},this),Promise.all(t)},SoundWave.prototype.getBufferFragment=function(e,t){if(0===this.buffer.length)throw new Error("Audio buffer empty. Nothing to copy.");if("undefined"==typeof e)return this.buffer;if(0>e&&(e=0),("undefined"==typeof t||t>this.buffer.length)&&(t=this.buffer.length),e>=t)throw new Error("Arguments out of bounds.");for(var n=this.buffer.numberOfChannels,r=t-e,o=core.createBuffer(n,r,core.sampleRate),f=0;n>f;f++)for(var u=o.getChannelData(f),i=this.buffer.getChannelData(f),a=0;r>a;a++)u[a]=i[e+a];return o},SoundWave.prototype.sortBinBuffers=function(e,t){return e.map(function(e){return t[e]})},module.exports=SoundWave;
