...
"use strict";var work=_dereq_("webworkify"),core=_dereq_("./core.js"),worker=_dereq_("./scheduleWorker.js"),Sequencer=function(){var e=this;this.ac=core,this.bpm=120,this.resolution=64,this.interval=100,this.lookahead=.3,this.queue=[],this.runqueue=[],this.timePerStep,this.nextStepTime=0,this.nextStep=0,this.lastPlayedStep=0,this.loop=!1,this.loopStart,this.loopEnd,this.isRunning=!1,this.animationFrame,this.timePerStep=this.setTimePerStep(this.bpm,this.resolution),this.scheduleWorker=work(worker),this.scheduleWorker.onmessage=function(t){"tick"===t.data&&e.scheduler()},this.scheduleWorker.postMessage({interval:this.interval})};Sequencer.prototype.scheduler=function(){var e=core.currentTime+this.lookahead;for(0===this.nextStepTime&&(this.nextStepTime=core.currentTime);this.nextStepTime<e;)this.addPartsToRunqueue(),this.fireEvents(),this.nextStepTime+=this.timePerStep,this.setQueuePointer()},Sequencer.prototype.addPartsToRunqueue=function(){if(this.queue[this.nextStep])if(1===this.queue[this.nextStep].length){var e=this.queue[this.nextStep][0];e.pointer=0,this.runqueue.push(e)}else this.queue[this.nextStep].forEach(function(e){e.pointer=0,this.runqueue.push(e)},this)},Sequencer.prototype.deletePartsFromRunqueue=function(e){e.length>0&&e.forEach(function(e){delete this.runqueue[e].pointer,this.runqueue.splice(e,1)},this)},Sequencer.prototype.fireEvents=function(){var e=[];this.runqueue.forEach(function(t,i){if(t.pointer===t.length-1)e.unshift(i);else{var r=t.pattern[t.pointer];r&&r.length>1?r.forEach(function(e){this.processSeqEvent(e,this.nextStepTime)},this):r&&1===r.length&&this.processSeqEvent(r[0],this.nextStepTime)}t.pointer++},this),this.deletePartsFromRunqueue(e)},Sequencer.prototype.processSeqEvent=function(e,t){t&&(e.props.delay=t),e.props.instrument.processSeqEvent(e)},Sequencer.prototype.setQueuePointer=function(e){this.loop?this.nextStep>=this.loopEnd?(this.nextStep=this.loopStart,this.runQueue=[]):this.nextStep++:e?this.nextStep=e:this.nextStep++},Sequencer.prototype.start=function(){this.isRunning||(this.scheduleWorker.postMessage("start"),this.isRunning=!0,window.requestAnimationFrame(this.draw.bind(this)))},Sequencer.prototype.stop=function(){this.scheduleWorker.postMessage("stop"),this.nextStepTime=0,this.isRunning=!1},Sequencer.prototype.draw=function(){var e=this.nextStepTime-core.currentTime;if(e>=0){var t=Math.round(e/this.timePerStep);this.nextStep<t?this.lastPlayedStep=this.loopEnd+this.nextStep-t:this.lastPlayedStep=this.nextStep-t,this.updateFrame(this.lastPlayedStep)}this.isRunning&&window.requestAnimationFrame(this.draw.bind(this))},Sequencer.prototype.updateFrame=function(e){console.log(e)},Sequencer.prototype.addPart=function(e,t){if(!e.length||!e.pattern)throw new Error("Given parameter doesn' seem to be a part object");this.queue[t]||(this.queue[t]=[]),this.queue[t].push(e)},Sequencer.prototype.removePart=function(e,t){if(!(this.queue[t]instanceof Array&&this.queue[t].length>0))throw new Error("Part not found at position "+t+".");var i=this.queue[t].indexOf(e);this.queue[t].splice(i,1)},Sequencer.prototype.setBpm=function(e){this.bpm=e,this.timePerStep=this.setTimePerStep(e,this.resolution)},Sequencer.prototype.setTimePerStep=function(e,t){return 240/(e*t)},Sequencer.prototype.getLastPlayedStep=function(){},Sequencer.prototype.copyArray=function(e){for(var t=new Array(e.length),i=e.length;i--;)t[i]=e[i];return t},module.exports=Sequencer;
},{"./core.js":7,"./scheduleWorker.js":9,"webworkify":2}],5:[function(_dereq_,module,exports){
"use strict";var core=_dereq_("./core.js"),Sound=function(t){if(this.wave=null,this.ac=core,this.queue=[],this.loop=!1,this.gainNode=null,this.pannerNode=null,this.soundLength=0,this.isPaused=!1,this.startOffset=0,this.startOffsets=[],this.startTime=0,this.loopStart=0,this.loopEnd=null,this.playbackRate=1,this.detune=0,!t)throw new Error("Error initialising Sound object: parameter missing.");this.wave=t,this.buffer=t.buffer,this.soundLength=this.loopEnd=this.buffer.duration,this.setupAudioChain()};Sound.prototype.setupAudioChain=function(){this.gainNode=core.createGain(),this.pannerNode=core.createStereoPanner(),this.gainNode.connect(this.pannerNode),this.pannerNode.connect(core.destination),this.gainNode.gain.value=1},Sound.prototype.createBufferSource=function(){var t=this,e=core.createBufferSource();return e.buffer=this.buffer,e.connect(this.gainNode),e.onended=function(){t.destroyBufferSource(e)},e},Sound.prototype.destroyBufferSource=function(t){t.disconnect(),this.queue.forEach(function(e,o){e===t&&this.queue.splice(o,1)},this)},Sound.prototype.start=function(t,e,o){if(this.isPaused&&this.queue.length>0)this.resume();else{var n=0;n=e?e:core.currentTime;var u=this.createBufferSource();t&&(u.loop=t,u.loopStart=this.loopStart,u.loopEnd=this.loopEnd),u.playbackRate.value=u.tmpPlaybackRate=this.playbackRate,u.detune.value=this.detune,u.startTime=n,this.queue.push(u),o?u.start(n,this.startOffset,o):u.start(n,this.startOffset),this.startOffset=0}},Sound.prototype.stop=function(){this.queue.forEach(function(t){t.stop(),t.disconnect()}),this.queue=[]},Sound.prototype.pause=function(){this.isPaused||(this.queue.forEach(function(t){t.tmpPlaybackRate=t.playbackRate.value,t.playbackRate.value=0}),this.isPaused=!0)},Sound.prototype.resume=function(){this.queue.forEach(function(t){t.playbackRate.value=t.tmpPlaybackRate,delete t.tmpPlaybackRate}),this.isPaused=!1},Sound.prototype.processSeqEvent=function(t){t.props.duration?this.start(!1,t.props.delay,t.props.duration):this.start(!1,t.props.delay)},Sound.prototype.setLoopStart=function(t){this.loopStart=t,this.queue.forEach(function(e){e.loopStart=t})},Sound.prototype.setLoopEnd=function(t){this.loopEnd=t,this.queue.forEach(function(e){e.loopEnd=t})},Sound.prototype.releaseLoop=function(){this.queue.forEach(function(t){t.loop=!1})},Sound.prototype.resetLoop=function(){this.loopStart=0,this.loopEnd=this.soundLength},Sound.prototype.setPlaybackRate=function(t){this.playbackRate=t,this.queue.forEach(function(e){e.playbackRate.value=t})},Sound.prototype.getPlaybackRate=function(){return this.playbackRate},Sound.prototype.setTone=function(t){if(!(t>=-12&&12>=t))throw new Error("Semi tone is "+t+". Must be between +/-12.");this.detune=100*t},Sound.prototype.getTone=function(){return this.detune/100},Sound.prototype.setDetune=function(t){if(!(t>=-1200&&1200>=t))throw new Error("Detune parameter is "+t+". Must be between +/-1200.");this.detune=t},Sound.prototype.getDetune=function(){return this.detune},Sound.prototype.getUID=function(){return Math.random().toString().substr(2,8)},module.exports=Sound;
},{"./core.js":7}],6:[function(_dereq_,module,exports){
"use strict";var core=_dereq_("./core.js"),SoundWave=function(e){this.buffer=null,this.metaData=[];var t=this;if(e)if(e instanceof ArrayBuffer)this.decodeAudioData(e);else if(e instanceof Array&&e[0]instanceof ArrayBuffer)this.concatBinariesToAudioBuffer(e);else if("string"==typeof e&&-1===e.indexOf(","))this.loadFile(e,function(e){t.buffer=t.decodeAudioData(e)});else{if(!("string"==typeof e&&e.indexOf(",")>-1))throw new Error("Cannot create SoundWave object: Unsupported data format");var n=this.loadFiles(e);this.buffer=this.concatBinariesToAudioBuffer(n,this.buffer)}};SoundWave.prototype.decodeAudioData=function(e){this.buffer=core.decodeAudioData.call(this,e).then(function(e){this.buffer=e})},SoundWave.prototype.concatBinariesToAudioBuffer=function(e,t){return e.forEach(function(e){var n=this.decodeAudioData(e);this.metaData.push(this.addWaveMetaData(t,n)),t=this.appendAudioBuffer(t,n)},this),t},SoundWave.prototype.appendAudioBuffer=function(e,t){for(var n=Math.min(e.numberOfChannels,t.numberOfChannels),o=core.createBuffer(n,e.length+t.length,e.sampleRate),a=0;n>a;a++){var r=o.getChannelData(a);r.set(e.getChannelData(a),0),r.set(t.getChannelData(a),e.length)}return o},SoundWave.prototype.addWaveMetaData=function(e,t){return{start:e.length+1,end:e.length+t.length,length:t.length}},SoundWave.prototype.loadFile=function(e,t,n){var o=this,a=!0,r=new window.XMLHttpRequest;r.addEventListener("progress",o.updateProgress),r.addEventListener("load",o.transferComplete),r.addEventListener("error",o.transferFailed),r.addEventListener("abort",o.transferCanceled),n&&(a=n),r.open("GET",e,a),r.responseType="arraybuffer",r.onload=function(){t(r.response)},r.send()},SoundWave.prototype.updateProgress=function(){},SoundWave.prototype.transferComplete=function(){},SoundWave.prototype.transferFailed=function(){},SoundWave.prototype.transferCanceled=function(){},SoundWave.prototype.loadFiles=function(e){var t=this,n=[],o=e.split(",");return o.forEach(function(e){t.loadFile(e,function(t){n[e]=t})}),this.sortBinBuffers(o,n)},SoundWave.prototype.sortBinBuffers=function(e,t){return e.map(function(e){return t[e]})},module.exports=SoundWave;
},{"./core.js":7}],7:[function(_dereq_,module,exports){
"use strict";var audioCtx=null;!function(){if(window.AudioContext=window.AudioContext||window.webkitAudioContext,!window.AudioContext)throw new Error("Couldn't initialize the audio context.");audioCtx=new window.AudioContext}(),module.exports=audioCtx;
