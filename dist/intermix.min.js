...
"use strict";var core=_dereq_("./core.js"),SoundWave=function(e){var t=this;if(this.ac=core,this.buffer=core.createBuffer(1,0,core.sampleRate),this.metaData=[],"undefined"!=typeof e)if("string"==typeof e)this.buffer=this.loadFile(e).then(function(e){return t.decodeAudioData(e)}).then(function(e){return t.buffer=e,t.buffer})["catch"](function(e){throw e});else if(e instanceof Array&&"string"==typeof e[0])this.buffer=this.loadMultipleFiles(e).then(function(e){t.buffer=e})["catch"](function(e){throw e});else if(e instanceof ArrayBuffer)this.buffer=this.decodeAudioData(e);else{if(!(e instanceof Array&&e[0]instanceof ArrayBuffer))throw new Error("Cannot create SoundWave object: Unsupported data format");this.decodeAudioSources(e).then(function(e){return t.joinAudioBuffers(e)}).then(function(e){this.buffer=e})}};SoundWave.prototype.loadMultipleFiles=function(e){var t=this;return this.loadFiles(e).then(function(e){return t.decodeAudioSources(e)}).then(function(e){return t.joinAudioBuffers(e)}).then(function(e){return e})["catch"](function(e){throw e})},SoundWave.prototype.decodeAudioSources=function(e){var t=[];return e.forEach(function(e){t.push(this.decodeAudioData(e))},this),Promise.all(t)},SoundWave.prototype.decodeAudioData=function(e){return core.decodeAudioData(e)},SoundWave.prototype.joinAudioBuffers=function(e){var t=this,o=core.createBuffer(1,0,core.sampleRate);return new Promise(function(n,r){e.forEach(function(e){e instanceof window.AudioBuffer?o=this.appendAudioBuffer(o,e):r(new TypeError("One or more buffers are not of type AudioBuffer."))},t),n(o)})},SoundWave.prototype.appendAudioBuffer=function(e,t){if(e instanceof window.AudioBuffer&&t instanceof window.AudioBuffer){for(var o=Math.min(e.numberOfChannels,t.numberOfChannels),n=core.createBuffer(o,e.length+t.length,e.sampleRate),r=0;o>r;r++){var u=n.getChannelData(r);u.set(e.getChannelData(r),0),u.set(t.getChannelData(r),e.length)}return n}throw new TypeError("One or both buffers are not of type AudioBuffer.")},SoundWave.prototype.getMetaData=function(e,t){if(e instanceof window.AudioBuffer&&"string"==typeof t){var o=this.buffer.length,n=e.length;return{name:t,start:o,end:o+n-1,length:n}}throw new TypeError("Arguments should be of type AudioBuffer and String")},SoundWave.prototype.loadFile=function(e){return window.fetch(e).then(function(t){if(t.ok)return t.arrayBuffer();throw new Error("Server error. Couldn't load file: "+e)})},SoundWave.prototype.loadFiles=function(e){var t=[];return e.forEach(function(e){t.push(this.loadFile(e))},this),Promise.all(t)},SoundWave.prototype.sortBinBuffers=function(e,t){return e.map(function(e){return t[e]})},module.exports=SoundWave;
