...
"use strict";var core=_dereq_("./core.js"),SoundWave=function(e){this.ac=core,this.buffer=null,this.metaData=[];var t=this;if(e)if(e instanceof ArrayBuffer)this.decodeAudioData(e);else if(e instanceof Array&&e[0]instanceof ArrayBuffer)this.concatBinariesToAudioBuffer(e);else if("string"==typeof e&&-1===e.indexOf(","))this.loadFile(e,function(e){t.buffer=t.decodeAudioData(e)});else{if(!("string"==typeof e&&e.indexOf(",")>-1))throw new Error("Cannot create SoundWave object: Unsupported data format");var n=this.loadFiles(e);this.buffer=this.concatBinariesToAudioBuffer(n,this.buffer)}};SoundWave.prototype.decodeAudioData=function(e){var t=this;return core.decodeAudioData(e).then(function(e){t.buffer=e})},SoundWave.prototype.concatBinariesToAudioBuffer=function(e,t){return e.forEach(function(e){var n=this.decodeAudioData(e);this.metaData.push(this.addWaveMetaData(t,n)),t=this.appendAudioBuffer(t,n)},this),t},SoundWave.prototype.appendAudioBuffer=function(e,t){for(var n=Math.min(e.numberOfChannels,t.numberOfChannels),o=core.createBuffer(n,e.length+t.length,e.sampleRate),r=0;n>r;r++){var a=o.getChannelData(r);a.set(e.getChannelData(r),0),a.set(t.getChannelData(r),e.length)}return o},SoundWave.prototype.addWaveMetaData=function(e,t){return{start:e.length+1,end:e.length+t.length,length:t.length}},SoundWave.prototype.loadFile=function(e,t,n){var o=this,r=!0,a=new window.XMLHttpRequest;a.addEventListener("progress",o.updateProgress),a.addEventListener("load",o.transferComplete),a.addEventListener("error",o.transferFailed),a.addEventListener("abort",o.transferCanceled),n&&(r=n),a.open("GET",e,r),a.responseType="arraybuffer",a.onload=function(){t(a.response)},a.send()},SoundWave.prototype.updateProgress=function(){},SoundWave.prototype.transferComplete=function(){},SoundWave.prototype.transferFailed=function(){},SoundWave.prototype.transferCanceled=function(){},SoundWave.prototype.loadFiles=function(e){var t=this,n=[],o=e.split(",");return o.forEach(function(e){t.loadFile(e,function(t){n[e]=t})}),this.sortBinBuffers(o,n)},SoundWave.prototype.sortBinBuffers=function(e,t){return e.map(function(e){return t[e]})},module.exports=SoundWave;
