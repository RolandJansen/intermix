...
SoundWave.prototype.concatBinariesToAudioBuffer = function(binaryBuffers, audioBuffer, func) {
  ...
  binaryBuffers.forEach(function(binBuffer) {
    ...
    self.addWaveMetaData(audioBuffer, tmpAudioBuffer);
    audioBuffer = self.appendAudioBuffer(audioBuffer, tmpAudioBuffer);
  });
 ...
 * @private
 * @param  {[type]} existingBuffer [description]
 * @param  {[type]} newBuffer      [description]
